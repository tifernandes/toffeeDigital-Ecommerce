...
import { BadgeCheck, ChevronRight, MessageSquare, Phone, Mail, Instagram, MapPin, FileText, ArrowRight } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight">
                Soluções para <span className="text-yellow-400">Colecionadores</span> Exigentes
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl opacity-90 leading-relaxed">
                Expositores e cases de alta qualidade para proteger e valorizar sua coleção.
                Feitos por colecionadores, para colecionadores.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-4 sm:pt-6">
                <Button size="lg" className="w-full sm:w-auto bg-yellow-400 text-blue-900 hover:bg-yellow-300 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6">
                  Conheça o Catálogo
      ...
      <main className="flex-grow">
        ...
        <section id="sobre" className="py-24 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-4xl font-bold mb-6 text-blue-900">Sobre a The King of Boxes</h2>
              <div className="w-24 h-1 bg-yellow-400 mx-auto mb-8" />
              <p className="text-xl text-gray-600 leading-relaxed">
                Somos uma empresa 100% nacional especializada em expositores para colecionáveis,
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-blue-900">Qualidade Premium</h3>
                <p className="text-gray-600">
                  Nossos produtos são cuidadosamente projetados e fabricados com materiais de altíssima qualidade.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-blue-900">Produção Própria</h3>
                <p className="text-gray-600">
                  Contamos com nossa própria ferramentaria e injeção de plásticos para total controle de qualidade.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-4 text-blue-900">Suporte Especializado</h3>
                <p className="text-gray-600">
                  Nossa equipe está sempre pronta para ajudar e oferecer o melhor atendimento.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <section id="produtos" className="py-12 sm:py-16 md:py-24 bg-gray-50">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              className="text-center max-w-3xl mx-auto mb-16"
            >
              <h2 className="text-4xl font-bold mb-6 text-blue-900">Nossos Produtos</h2>
              <div className="w-24 h-1 bg-yellow-400 mx-auto mb-8" />
            ...
            {Object.entries(productsByCategory).map(([category, products], categoryIndex) => (
              <div key={category} className="mb-8 sm:mb-12 md:mb-16">
                <h3 className="text-xl sm:text-2xl font-bold text-blue-900 mb-6 sm:mb-8">{category}</h3>
                          ...
                          <div className="relative w-full h-[300px] sm:h-[350px] md:h-[400px] rounded-xl overflow-hidden">
                            <div className="relative w-full h-full group">
                              ...
                              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/60 flex items-end p-4 sm:p-6">
                                <div>
                                  <h3 className="text-lg sm:text-xl font-semibold text-white mb-2">{product.produto}</h3>
                                  <p className="text-sm sm:text-base text-white/80 line-clamp-2">{product.descricao}</p>
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            >
              <p className="text-xl font-medium mb-8 text-gray-600">E sempre temos novidades...</p>
        ...
        <section id="valores" className="py-12 sm:py-16 md:py-24 bg-white">
          <div className="container mx-auto px-4">
            <motion.div 
              ...
              className="text-center max-w-3xl mx-auto mb-16"
            >
              <h2 className="text-4xl font-bold mb-6 text-blue-900">Nossa Identidade</h2>
              <div className="w-24 h-1 bg-yellow-400 mx-auto mb-8" />
            </motion.div>
              ...
              <Tabs defaultValue="missao" className="max-w-4xl mx-auto">
                <div className="flex justify-center mb-8 sm:mb-12 overflow-x-auto">
                  <TabsList className="bg-gray-100 p-1 sm:p-2 rounded-full">
                    <TabsTrigger value="missao" className="rounded-full px-4 sm:px-8 py-2 sm:py-3 text-sm sm:text-base">Missão</TabsTrigger>
                    <TabsTrigger value="visao" className="rounded-full px-4 sm:px-8 py-2 sm:py-3 text-sm sm:text-base">Visão</TabsTrigger>
                    <TabsTrigger value="valores" className="rounded-full px-4 sm:px-8 py-2 sm:py-3 text-sm sm:text-base">Valores</TabsTrigger>
                  </TabsList>
                </div>
                
                <TabsContent value="missao" className="p-8 bg-gray-50 rounded-2xl shadow-lg">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                  >
                    <h3 className="text-2xl font-bold mb-6 text-blue-900">Nossa Missão</h3>
                    <p className="text-xl leading-relaxed text-gray-600">
                      Executar nossos serviços com excelência, de forma a atender as expectativas e
                      gerando satisfação dos nossos clientes.
                    </p>
                  </motion.div>
                </TabsContent>
                
                <TabsContent value="visao" className="p-8 bg-gray-50 rounded-2xl shadow-lg">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                  >
                    <h3 className="text-2xl font-bold mb-6 text-blue-900">Nossa Visão</h3>
                    <p className="text-xl leading-relaxed text-gray-600">
                      Ser referência em qualidade e comprometimento para nossos clientes e fornecedores.
                    </p>
                  </motion.div>
                </TabsContent>
                
                <TabsContent value="valores" className="p-8 bg-gray-50 rounded-2xl shadow-lg">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6 }}
                  >
                    <h3 className="text-2xl font-bold mb-6 text-blue-900">Nossos Valores</h3>
        ...
        {/* Contact Section */}
        <section id="contato" className="py-12 sm:py-16 md:py-24 bg-gradient-to-b from-gray-50 to-blue-900">
          <div className="container mx-auto px-4">
            <motion.div 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-blue-900">Entre em Contato</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 max-w-5xl mx-auto">
              ...
              >
                <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-blue-900">Fale Conosco</h3>
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-start p-3 sm:p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0"> {/* Adicionado flex-1 e min-w-0 para evitar overflow */}
                      <p className="font-medium text-gray-900 text-sm sm:text-base truncate">(XX) XXXX-XXXX</p>
                      <p className="text-xs sm:text-sm text-gray-500">Segunda a Sexta, 9h-18h</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-3 sm:p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 text-sm sm:text-base truncate">contato@thekingofboxes.com.br</p>
                  ...
                  <div className="flex items-start p-3 sm:p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 text-sm sm:text-base truncate">@thekingofboxes_</p>
                      <p className="text-xs sm:text-sm text-gray-500">Siga-nos para novidades</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start p-3 sm:p-4 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-gray-900 text-sm sm:text-base truncate">São Paulo - SP, Brasil</p>
                ...
                <div className="mt-6 sm:mt-8">
                  <Button size="lg" className="w-full bg-green-600 hover:bg-green-700 text-base sm:text-lg py-4 sm:py-6">
              ...
              <motion.div 
                ...
                className="bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-lg"
              >
                <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-blue-900">Envie uma mensagem</h3>
                <form className="space-y-4 sm:space-y-6">
                  ...
                  <Button size="lg" className="w-full bg-blue-900 hover:bg-blue-800 text-base sm:text-lg py-4 sm:py-6">
                    Enviar mensagem
