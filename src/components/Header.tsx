...
const Header: React.FC = () => {
  ...
  useEffect(() => {
    window.onscroll = function () {
      ...
      if (currentScrollPos < 100) {
        ...
        document.getElementById("containerFix")!.style.transform = "translateY(0px)";
      }
    };
  }, []);
  ...
  return (
    <>
      ...
      <header className="fixed top-0 left-0 w-full h-20 bg-white shadow-md transform -translate-y-full transition-transform duration-300 z-50" id="containerFix">
        <HeaderCmp />
      </header>
    </>
  );
